...
class Movies : AppCompatActivity(), MoviesInterface {

    private val moviesCollection = ArrayList<MovieInfo>()
    ...
    override fun onCardClick(position: Int, bundle: Bundle) {
        super.onCardClick(position, bundle)
    ...
    private fun setUpMovies() {
        ...
        for (movie in movies) {
            moviesCollection.add(MovieInfo(movie[0], movie[1], movie[2], movie[3], movie[4]))
        }
    }
}